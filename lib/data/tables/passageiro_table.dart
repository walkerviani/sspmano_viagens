...
class Passageiros extends Table {
  ...
  IntColumn get idVeiculo =>
      integer().references(Veiculos, #id, onDelete: KeyAction.cascade)();
  IntColumn get idPessoa => integer()
      .references(Pessoas, #id, onDelete: KeyAction.restrict)
      .nullable()();
